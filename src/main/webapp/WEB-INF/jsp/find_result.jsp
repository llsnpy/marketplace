...
<div class="row">
        ...
        <jsp:useBean id="buyer" class="by.mironenko.marketplace.entity.Buyer" scope="request"/>
        ...
        <jsp:useBean id="developer" class="by.mironenko.marketplace.entity.Developer" scope="request"/>
        <div class="col-lg-5 container-fluid">
            <h3>Seeking developer</h3>
        <table class="table table-bordered table-hover">
            <thead>
            <tr class="active">
                <th>Name</th>
            ...
            <tr>
                ...
                <td><c:out value="${developer.money}"/></td>
                <td><c:out value="${developer.rating}"/></td>
            </tr>
            </tbody>
        </table>
    </div>

        <jsp:useBean id="game" class="by.mironenko.marketplace.entity.Game" scope="request"/>
        <div class="col-lg-5 container-fluid">
            <h3>Seeking game</h3>
        <table class="table table-bordered table-hover">
            <thead>
