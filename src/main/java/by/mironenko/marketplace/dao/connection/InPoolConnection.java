...
public class InPoolConnection implements Connection, Comparable<InPoolConnection> {

    private Connection connection;

    public InPoolConnection(Connection connection) {
    ...
    @Override
    public int compareTo(InPoolConnection connection) {
